...
<div align="center">
<h2><a href="" class="btn btn-danger triggerRemove">&laquo;</a>
increase or decrease days uses CRON
<a href="/admin/cronForward.html" class="btn btn-danger triggerRemove">&raquo;</a>
</h2>
</div>
<br>
<div>
...
<ul class="pagination pagination-sm">
		...
		for(int i = 0;i<allPages;i++){
			%>
			<c:set var="i" value="<%=i%>" />
			<li class="${page == i ? 'active' : ''}" ><a href="/admin/user.html?page=<%= i %>"><%= i+1 %></a></li>
			<% 
		}
		%>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">You are about to shift the whole plan by 1 day</h4>
			</div>
