    ...
    <div id="contact" >
        <div class="container">
            ...
            <div class="row  text-center wow rotateIn animated" data-wow-delay="0.4s">
                <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                 <a href="#">   <img src="/resources/assets/img/Social/facebook.png" alt="" /></a>
                  <a href="#">   <img src="/resources/assets/img/Social/google-plus.png" alt="" /></a>
                  <a href="#">   <img src="/resources/assets/img/Social/twitter.png" alt="" /></a>
                    </div>
                </div>
