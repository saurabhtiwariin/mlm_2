	...
	<div class="container">
		...
		<div class="row ">
				...
				<div class="media wow rotateIn animated" data-wow-delay="0.2s">
					...
					<div class="media-body">
						...
						<p>Aenean faucibus luctus enim. Duis quis sem risu suspend
							lacinia elementum nunc. Aenean faucibus luctus enim.</p>
			...
			<div class="col-lg-4 col-md-4 wow bounceInDown animated"
				style="padding: 10px;" data-wow-delay="0.6s">
				<div id="carousel-slider" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="item">
							...
							<img src="/resources/assets/img/slider/1.jpg" class="img-thumbnail" alt="">
						</div>
						<div class="item">
							<img src="/resources/assets/img/slider/2.png" class="img-thumbnail" alt="">
						</div>
						<div class="item active">
							<img src="/resources/assets/img/slider/3.jpg" class="img-thumbnail" alt="">
						</div>
					</div>
					<!--INDICATORS-->
		...
		<div class="row pad-top-botm wow flipInX animated"
			...
			<div class="col-lg-8 col-md-8 col-sm-8 ">
				...
				<h3>
					<strong>What is our profile ?</strong>
				</h3>
