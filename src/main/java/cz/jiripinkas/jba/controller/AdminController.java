...
public class AdminController {
	...
	public String updateOTPTableAdmin(Model model,
			@ModelAttribute("otp") OTP otp,@RequestParam("page") int page, BindingResult result,
			RedirectAttributes redirectAttributes) {
	...
	public String bankDetailsGet(Model model, @RequestParam("page") int page) {
		...
		List<BankDetails> bankDetailsList = bankDetailsService.getTableData(page);
	...
	public String commitPost(Model model,
			@ModelAttribute("commit") Commit commit,@RequestParam("page") int page, BindingResult result,
			RedirectAttributes redirectAttributes) {
		logger.info("inside post *******************");
		if (result.hasErrors()) {
			logger.info("inside binding result");
